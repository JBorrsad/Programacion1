...
public class TestAgendaFestivales {
    ...
    private static void testCargarAgenda(Agenda agenda) {
        FestivalesIO.cargarFestivales(agenda);
        System.out.println(agenda);
        System.out.println();
    }

    private static void testFestivalesEnMes(Agenda agenda) {
    ...
    private static void testFestivalesPorEstilo(Agenda agenda) {
    ...
    private static void testCancelarFestivales(Agenda agenda) {
        HashSet<String> lugares = new HashSet<>(Arrays.asList("VITORIA", "BILBAO", "ZARAGOZA"));
    ...
    private static void testCancelarFestivales(Agenda agenda, Mes mes, HashSet<String> lugares) {
