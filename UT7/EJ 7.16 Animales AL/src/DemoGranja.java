...
public class DemoGranja {
    ...
    public void testGranja() {
        g.addAnimal(new Perro("toby", 4, "sof�", new Persona("pepe", 44)));
        Animal a = new Gato("caty", 4, new Persona("juan", 12), "pelota");
        g.addAnimal(a);
        g.addAnimal(
                new Perro("churri", 4, "suelo", new Persona("agust�n", 46)));
        ...
        g.mostrarAnimales();
        System.out.println("Total perros en la granja " + g.cuantosPerros());
    }
    ...
    public void testVacasIguales() {
        ...
        System.out.println("Vacas iguales a la dada " + g.vacasIgualesA(v));
    }
